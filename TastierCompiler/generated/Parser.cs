		...
		if (external) {
		    externalDeclarations.Push(new Symbol(name, (int)TastierKind.Var, (int)type, 0, 0));
		                            ...
		                            if (openScopes.Count == 1) {
		                              ...
		                              l = currentScope.Count(s => s.Item2 == (int)TastierKind.Var ||
		                            s.Item2 == (int)TastierKind.Const);
		                            }
		
		                            currentScope.Push(new Symbol(name, (int)TastierKind.Var, (int)type,
		...
		while (la.kind == 35) {
			...
			externalDeclarations.Push(new Symbol(name, (int)TastierKind.Var, (int)type, 0, 0));
			 ...
			 if (openScopes.Count == 1) {
			   ...
			   l = currentScope.Count(s => s.Item2 == (int)TastierKind.Var || s.Item2 == (int)TastierKind.Const);
			 }
...
TastierKind kind) {
	...
	static readonly bool[,] set = {
		...
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,T,x, x,T,x,x, x,x,x,x, x,x,x,x, x,T,x,T, T,x,T,x, x,T,T,x, x,T,T,T, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x,x,x,x, x,T,x,T, T,x,T,x, x,T,T,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x,x,x,x, x,T,x,T, T,x,T,x, x,T,T,x, x,T,T,T, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,x,T,x, x}
